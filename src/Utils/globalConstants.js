...
export const actionsType = {
  ...
  // FETCH VIDEO
  FETCH_ALL_VIDEO_SHARED: 'FETCH_ALL_VIDEO_SHARED',
  FETCH_ALL_VIDEO_SHARED_SUCCESS: 'FETCH_ALL_VIDEO_SHARED_SUCCESS',
  FETCH_ALL_VIDEO_SHARED_FAIL: 'FETCH_ALL_VIDEO_SHARED_FAIL',
  CANCEL_FETCH_ALL_VIDEO_SHARED: 'CANCEL_FETCH_ALL_VIDEO_SHARED',
